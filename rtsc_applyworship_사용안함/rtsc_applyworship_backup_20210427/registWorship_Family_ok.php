<?php
	...
	while($row = mysqli_fetch_assoc($result)){
		...
		if ($registWorship != ""){
			...
			if ($total_count == 0){
				$sql_worship = "insert into apply_worship (worshipDate, worshipGubun, churchareaCode, rtdept1Code, korname, gender, churchPositionCode, mobile, birthday, inputDate, appYN, busUse, familyID, strollerYN, wheelchairYN, worshipPlace, useLanguage, carNo)values('".$worshipDate."','".$worshipGubun."','".$churchareaCode."','".$rtdept1Code."','".$korname."','".$gender."','".$churchPositionCode."','".$mobile."','".$birthday."', now(),'".$appYN."','".$busUse."','".$familyID."','".$strollerYN."','".$wheelchairYN."','".$worshipPlace."','".$useLanguage."','".$carNo."')";
			}else{
