<?php
	...
	if ($total_count == 0){
		$sql_worship = "insert into apply_worship (worshipDate, worshipGubun, korname, churchPositionCode, gender, birthday, mobile, churchareaCode, rtdept1Code, familyID, appYN, busUse, strollerYN, wheelchairYN, carNo, worshipPlace, useLanguage, inputDate) values ('".$worshipDate."', '".$worshipGubun."', '".$korname."', '".$churchPositionCode."', '".$gender."', '".$birthday."', '".$mobile."', '".$churchareaCode."', '".$rtdept1Code."', '', '".$appYN."', '".$busUse."', '".$strollerYN."', '".$wheelchairYN."', '".$carNo."','".$worshipPlace."', '".$useLanguage."', now())";
	}else{
		# 가족등록으로 예배신청을 했을 수가 있으므로 가족ID는 업데이트 하지 않도록 한다. familyID = '".$familyID."'
		$sql_worship = "update apply_worship set worshipGubun = '".$worshipGubun."', churchareaCode = '".$churchareaCode."', rtdept1Code = '".$rtdept1Code."', korname = '".$korname."', gender = '".$gender."', churchPositionCode = '".$churchPositionCode."', mobile = '".$mobile."', birthday = '".$birthday."', appYN = '".$appYN."', busUse = '".$busUse."', strollerYN = '".$strollerYN."', wheelchairYN = '".$wheelchairYN."', carNo = '".$carNo."', worshipPlace = '".$worshipPlace."', useLanguage = '".$useLanguage."' inputDate = now() where worshipDate = '".$worshipDate."' and korname = '".$korname."' and birthday = '".$birthday."'";
	}
