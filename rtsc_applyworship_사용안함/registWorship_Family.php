						...
						<ul class="list-group list-group-unbordered mb-3">
						  ...
						  <li class="list-group-item">
							<div class="custom-control custom-checkbox">
								<input class="custom-control-input custom-control-input-danger" type="checkbox" id="registWorship<?php echo $row_faimly['idx']?>" name="registWorship<?php echo $row_faimly['idx']?>" value="<?php echo $row_faimly['idx']?>" checked> <label for="registWorship<?php echo $row_faimly['idx']?>" class="custom-control-label"><b><font color="red">예배 신청합니다.(※ 예배 신청하실 분은 반드시 체크해주세요.)</font></b></label>
							</div>
						  </li>
						  <li class="list-group-item">
						  ...
						  <li class="list-group-item">
							<select class="custom-select rounded-0" name="worshipPlace<?php echo $row_faimly['idx']?>">
								...
								<option value="농인부실"<?php if ($row_faimly['worshipPlace'] == "농인부실"){echo " selected";} ?>>농인부실</option>
								<option value="TCK부실"<?php if ($row_faimly['worshipPlace'] == "TCK부실"){echo " selected";} ?>>TCK부실</option>
								<option value="청년부실"<?php if ($row_faimly['worshipPlace'] == "청년부실"){echo " selected";} ?>>청년부실</option>
								<option value="영어예배부실"<?php if ($row_faimly['worshipPlace'] == "영어예배부실"){echo " selected";} ?>>영어예배부실</option>
								<option value="중국어예배부실"<?php if ($row_faimly['worshipPlace'] == "중국어예배부실"){echo " selected";} ?>>중국어예배부실</option>
								<option value="일본어예배부실"<?php if ($row_faimly['worshipPlace'] == "일본어예배부실"){echo " selected";} ?>>일본어예배부실</option>
								<option value="스페인어예배부실"<?php if ($row_faimly['worshipPlace'] == "스페인어예배부실"){echo " selected";} ?>>스페인어예배부실</option>
								<option value="러시아어예배부실"<?php if ($row_faimly['worshipPlace'] == "러시아어예배부실"){echo " selected";} ?>>러시아어예배부실</option>
								<option value="북한선교부실"<?php if ($row_faimly['worshipPlace'] == "북한선교부실"){echo " selected";} ?>>북한선교부실</option>
