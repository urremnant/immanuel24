<?php
	...
	header("Content-Disposition: attachment; filename=".date('Ymd')."_교사리스트.xls" );


//	$rtdept1Code = "D10001";
//	$rtdept2Code = "D20150";
	$sql = "select a.*, b.rtdept1Name, ifnull((select rtdept2Name from rtdept2 where rtdept2Code = a.rtdept2Code), '') as rtdept2Name, a.korname, c.korChurchPosition, d.korChurchAreaName, d.korParishName, e.korProfessional, f.korCountryName from member a, rtdept1 b, churchPosition c, churcharea d, expertMeeting e, country f where a.rtdept1Code = b.rtdept1Code and a.churchPositionCode = c.churchPositionCode and a.churchareaCode = d.churchareaCode and a.expertMeetingCode = e.expertMeetingCode and a.countryCode = f.countryCode and a.memberID like 'T%' order by rtdept1Code, rtdept2Code, korname";
//	echo $sql;
