...
//								alert(rtdept2Code);
							...
							<div class="col-sm-2">
								...
								<?php
									...
									if (($rtdept1Code == "D10009") || ($rtdept1Code == "D10012") || ($rtdept1Code == "D10014") || ($rtdept1Code == "D10015")){
								?>
						...
						<tr>
							...
							<td>
								<?php 
									...
									if ($list[$i]['teacherGubun'] <> ""){
										echo "/".$list[$i]['teacherGubun'];
									}
								?>
							</td>
							<td>
