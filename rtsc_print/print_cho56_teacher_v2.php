    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
<?php
	$sql = "select memberID, a.photofilename, a.korname, a.gender, a.job, a.mobile, a.email, a.address, a.prayertopic, d.korParishName from member a, churchPosition c, churcharea d, country e where a.churchPositionCode = c.churchPositionCode and a.churchareaCode = d.churchareaCode and a.countryCode = e.countryCode and a.rtdept1Code = 'D10006' and left(a.memberID,1) = 'T'  order by a.rtdept2Code, a.korname";
