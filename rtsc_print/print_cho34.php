...
<?php
	...
	while ($row = mysqli_fetch_assoc($result)) {
		...
		case "B":
				$i=0;
?>
				<table class="breakpoint">
					<tr>
						<td bgcolor="#ffffff">
							<table border="0" cellpadding="3" cellspacing="0">
								<tr bgcolor="#ffffff" height="5" valign="top">
									<td></td>
								</tr>
							</table>
						</td>
...
<?php
		...
		case "C":
?>
				<table class="table <?php If (($i%3)==0){echo "breakpoint";}?>">
					<tr>
						<td bgcolor="#ffffff">
							<table border="0" cellpadding="3" cellspacing="0">
								<tr bgcolor="#ffffff" height="5" valign="top">
					...
					<table class="table">
					  <tbody>
						<tr>
						  ...
						  <td style="width:10%">이름</td>
						  <td style="width:30%"><b><?php echo $row['korname']?></b></td>
						  <td style="width:30%"><?php echo $row['schoolinfo']?></td>
						</tr>
						<tr>
						  <td>비전</td>
