					...
					<table class="table">
					  <tbody>
						<tr>
						  ...
						  <td style="width:30%"><b><?php echo $row['korname']?></b></td>
						  <td style="width:30%">담임</td>
						</tr>
						<tr>
						  <td>직업</td>
					  ...
					  <tbody>
						<tr>
						  ...
						  <td style="width:25%">
							<?php
								if ($row['birthday']<>""){
									echo substr($row['birthday'], 0, 4)."년 ".substr($row['birthday'], 4, 2)."월 ".substr($row['birthday'],-2)."일";
								}
							?>
						  </td>
						</tr>
						...
						<tr>
						  <td>비전</td>
						  <td colspan="3"><?php echo $row['vision']?></td>
						</tr>
						<tr>
						  <td>부</td>
						  <td>
