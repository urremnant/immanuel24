...
<?php
	...
	if (($_SESSION['ss_rtdept1code']=="D00001")  || ($_SESSION['ss_rtdept1code']=="D00020") || ($_SESSION['ss_rtdept1code']=="D10014") || ($_SESSION['ss_rtdept1code']=="D00007") || ($_SESSION['ss_rtdept1code']=="D00008") || ($_SESSION['ss_rtdept1code']=="D00009") || ($_SESSION['ss_rtdept1code']=="D00010")){
?>
<!-- 농인부 시작 -->
          <li class="nav-item menu-open">
            <a href="#" class="nav-link">
...
<?php
	...
	if (($_SESSION['ss_rtdept1code']=="D00001")  || ($_SESSION['ss_rtdept1code']=="D00021") || ($_SESSION['ss_rtdept1code']=="D10015") || ($_SESSION['ss_rtdept1code']=="D00007") || ($_SESSION['ss_rtdept1code']=="D00008") || ($_SESSION['ss_rtdept1code']=="D00009") || ($_SESSION['ss_rtdept1code']=="D00010")){
?>
<!-- TCK부 시작 -->
          <li class="nav-item menu-open">
            <a href="#" class="nav-link">
...
?>
	...
	?>
		...
		<!-- 농인부 시작 -->
	<?php
		if (($_SESSION['ss_rtdept1code']=="D00001")  || ($_SESSION['ss_rtdept1code']=="D00019") || ($_SESSION['ss_rtdept1code']=="D10014") || ($_SESSION['ss_rtdept1code']=="D00007") || ($_SESSION['ss_rtdept1code']=="D00008") || ($_SESSION['ss_rtdept1code']=="D00009") || ($_SESSION['ss_rtdept1code']=="D00010")){
	?>
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
	...
	?>
		...
		<!-- TCK부 시작 -->
	<?php
		if (($_SESSION['ss_rtdept1code']=="D00001")  || ($_SESSION['ss_rtdept1code']=="D00020") || ($_SESSION['ss_rtdept1code']=="D10015") || ($_SESSION['ss_rtdept1code']=="D00007") || ($_SESSION['ss_rtdept1code']=="D00008") || ($_SESSION['ss_rtdept1code']=="D00009") || ($_SESSION['ss_rtdept1code']=="D00010")){
	?>
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
