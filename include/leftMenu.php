	...
	?>
		<!-- TCK부 끝 -->
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
					<a href="/rtsc_attendchcek/totalMonthAll.php" class='nav-link'>
                    <i class="far fa-circle nav-icon"></i>
                    <p>월간 출석통계</p>
                    </a>
				</li>
            ...
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
					<a href="/rtsc_attendchcek/totalDept2.php" class='nav-link'>
                    <i class="far fa-circle nav-icon"></i>
                    <p>부서별/반별 출석통계</p>
                    </a>
				</li>
            ...
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
					<a href="/rtsc_attendchcek/totalDept_TCK.php" class='nav-link'>
                    <i class="far fa-circle nav-icon"></i>
                    <p>TCK부 출석통계</p>
                    </a>
				</li>
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
					<a href="/rtsc_map/mapDept.php" class="nav-link">
          ...
          <li class="nav-item menu-open">
            <ul class="nav nav-treeview">
				<li class="nav-item menu-open">
					<a href="/rtsc_internship/internship.php" class="nav-link">
