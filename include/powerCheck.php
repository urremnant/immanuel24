...
//--------------
			...
			if ($_SESSION['ss_rtdept1code'] == "D00002"){
				if (($rtdept1Code == "D10001") || ($rtdept1Code == "D10002") || ($rtdept1Code == "D10003")){
					...
					echo "<script>alert('미취학국을 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}
			}
			...
			if ($_SESSION['ss_rtdept1code'] == "D00003"){
				if (($rtdept1Code == "D10004") || ($rtdept1Code == "D10005") || ($rtdept1Code == "D10006")){
					...
					echo "<script>alert('초등렘넌트국을 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}				
			}
			...
			if ($_SESSION['ss_rtdept1code'] == "D00004"){
				if (($rtdept1Code == "D10007") || ($rtdept1Code == "D10008")){
					...
					echo "<script>alert('청소년렘넌트국을 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}					
			}			
			//대학국 - 대학부 열람이 가능하다.
			if ($_SESSION['ss_rtdept1code'] == "D00005"){
				if ($rtdept1Code == "D10009"){
					...
					echo "<script>alert('대학부를 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}					
			}
			//미션렘넌트국 - 사랑부, 농인부 열람이 가능하다.
			if ($_SESSION['ss_rtdept1code'] == "D00006"){
				if (($rtdept1Code == "D10012") || ($rtdept1Code == "D10014")){
				}else{
					echo "<script>alert('미션렘넌트국을 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}					
			}
			//글로벌렘넌트국 - TCK부, 해외유학생부 열람이 가능하다.
			if ($_SESSION['ss_rtdept1code'] == "D00006"){
				if (($rtdept1Code == "D10015") || ($rtdept1Code == "D10016")){
				}else{
					echo "<script>alert('글로벌렘넌트국을 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}					
			}
...
//--------------
			...
			if ($_SESSION['ss_rtdept1code'] == "D10001"){
				if ($_SESSION['ss_rtdept1code'] != $rtdept1Code){
					echo "<script>alert('다른 부서를 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}
			}
			//유아부
			...
			if ($_SESSION['ss_rtdept1code'] == "D10006"){
				if ($_SESSION['ss_rtdept1code'] != $rtdept1Code){
					echo "<script>alert('초등56부를 열람할 권한이 없습니다.');history.back();</script>";
					exit;
				}
			}
			//중등부
			...
			//농인부
			if ($_SESSION['ss_rtdept1code'] == "D10014"){
				if ($_SESSION['ss_rtdept1code'] != $rtdept1Code){
			...
			//TCK부
			if ($_SESSION['ss_rtdept1code'] == "D10015"){
				if ($_SESSION['ss_rtdept1code'] != $rtdept1Code){
					echo "<script>alert('다른 부서를 열람할 권한이 없습니다.');self.close();</script>";
					exit;
				}
