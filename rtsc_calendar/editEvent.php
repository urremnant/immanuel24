...
<?php 
	...
	switch($row['isAllday']){
		...
		case "R":
			...
			$repeatStartDate = $row['startYear']."-". $row['startMonth']."-".$row['startDay'];
			$repeatEndDate = $row['endYear']."-". $row['endMonth']."-".$row['endDay'];
			$repeatStartTime = $row['startTime'].":".$row['startMinute'];
			$repeatEndTime = $row['endTime'].":". $row['endMinute'];
			break;
	}
              ...
              <form class="form-horizontal" method ="POST" name="schedule" action="editEvent_ok.php" onsubmit="return sendit()">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
					...
					<div class="col-sm-10">
						<div class="form-check">
							<input class="form-check-input" type="radio" name="isAllday" value="R" onclick="javascript:isAlldayCheck();"<?php if ($row['isAllday'] == "R"){echo " checked";}?>><label class="form-check-label">반복일정</label>
						</div>
					...
					<div class="col-sm-2">
						<div class="form-group">
							<div class="input-group date" id="repeatStartDate" data-target-input="nearest">
								...
								<input type="text" name="repeatStartDate" class="form-control datetimepicker-input" data-target="#repeatStartDate" value="<?php echo $repeatStartDate; ?>">
							</div>
						</div>
					</div>
					...
					<div class="col-sm-2">
						<div class="form-group">
							<div class="input-group date" id="repeatEndDate" data-target-input="nearest">
								...
								<input type="text" name="repeatEndDate" class="form-control datetimepicker-input" data-target="#repeatEndDate" value="<?php echo $repeatEndDate; ?>">
							</div>
						</div>
					</div>
                  </div>
					...
					<div class="col-sm-2">
						<div class="form-group">
							<div class="input-group date" id="repeatStartTime" data-target-input="nearest">
								...
								<input type="text" name="repeatStartTime" class="form-control datetimepicker-input" data-target="#repeatStartTime" value="<?php echo $repeatStartTime; ?>">
							</div>
						</div>		
					</div>
					<div class="col-sm-1 text-center">
					...
					<div class="col-sm-2">
						<div class="form-group">
							<div class="input-group date" id="repeatEndTime" data-target-input="nearest">
								...
								<input type="text" name="repeatEndTime" class="form-control datetimepicker-input" data-target="#repeatEndTime" value="<?php echo $repeatEndTime; ?>">
							</div>
						</div>	
					</div>
                  </div>
                  ...
                  <div class="form-group row">
					...
					<div class="col-sm-9">
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek1" value="Y"<?php if (strpos($row['dayofweek'],1)){echo " checked";}?>>
							<label class="form-check-label">월요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek2" value="Y"<?php if (strpos($row['dayofweek'],2)){echo " checked";}?>>
							<label class="form-check-label">화요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek3" value="Y"<?php if (strpos($row['dayofweek'],3)){echo " checked";}?>>
							<label class="form-check-label">수요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek4" value="Y"<?php if (strpos($row['dayofweek'],4)){echo " checked";}?>>
							<label class="form-check-label">목요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek5" value="Y"<?php if (strpos($row['dayofweek'],5)){echo " checked";}?>>
							<label class="form-check-label">금요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek6" value="Y"<?php if (strpos($row['dayofweek'],6)){echo " checked";}?>>
							<label class="form-check-label">토요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek0" value="Y"<?php if (strpos($row['dayofweek'],0)){echo " checked";}?>>
							<label class="form-check-label">일요일</label>
						</div>
						<div class="btn-group form-check">
							<input class="form-check-input" type="checkbox" name="repeatDayOfWeek7" value="Y"<?php If ($row['dayofweek']=="[0,1,2,3,4,5,6]"){echo " checked";}?> onclick="javascript:everyDayCheck()">
