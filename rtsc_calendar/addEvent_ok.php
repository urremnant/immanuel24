...
//		echo "endMinute : ".$endMinute."<br>";
	...
	$sql  = "insert into calendar (homepage_admin_idx, calendar_category_idx, startYear, startMonth, startDay, startTime, startMinute, endYear, endMonth, endDay, endTime, endMinute, isAllday, dayofweek, url, title, content, inputDate) values ('".$_SESSION['ss_homepage_admin_idx']."',  '".$calendar_category_idx."', '".$startYear."', '".$startMonth."', '".$startDay."', '".$startTime."', '".$startMinute."', '".$endYear."', '".$endMonth."', '".$endDay."', '".$endTime."', '".$endMinute."', '".$isAllday."', '".$dayofweek."', '".$url."', '".$title."', '".$content."', now())";
