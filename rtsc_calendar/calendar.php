...
//		contentHeight: 'auto',
		...
		},{googleCalendarId : 'infooffice3@gmail.com' , className : '본부일정'}],
			...
			<div class="modal-footer justify-content-between">
				...
				<div class="col-md-4">
					...
					$('#calendarModal').on('show.bs.modal', function (event) {
						...
						if (userID == "<?php echo $_SESSION['ss_homepage_admin_idx']?>"){
							document.getElementById('editdeletebutton').innerHTML='<a class="btn btn-info btn-sm" href="javascript:editEvent();"><i class="fas fa-pencil-alt"></i>Edit</a>&nbsp;<a class="btn btn-danger btn-sm" href="javascript:delEvent();"><i class="fas fa-trash"></i>Delete</a>';
						}else{
							document.getElementById('editdeletebutton').innerHTML='';
						}
					})
					</script>
					<div id="editdeletebutton"></div>
				</div>
			</div>
		</div>
	</div>
