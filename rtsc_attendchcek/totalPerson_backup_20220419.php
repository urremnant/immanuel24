            ...
            <div class="card">
				...
				<!--
					...
					function downloadExcel(){
						...
						location.href="totalPerson_exceldownload.php?total_rtdept1Code="+total_rtdept1Code+"&worshipStartDate="+worshipStartDate+"&worshipEndDate="+worshipEndDate;
					}
				//-->
				</script>
				...
				<div class="card-body">
						<div class="form-group row">
								...
								<?php
									# 현재 년도와 날짜를 구한다.
									$today = date("Y-m-d");
									$sql_worshipDate = "select worshipDate from attendbasedate where worshipDate <= '".$today."' order by worshipDate";
