						...
						<div class="form-group row">
								...
								<div class="col-sm-2">
									...
									<?php
										...
										if (($total_rtdept1Code == "D10012") || ($total_rtdept1Code == "D10014") || ($total_rtdept1Code == "D10015") || ($total_rtdept1Code == "D10016") || ($total_rtdept1Code == "")){
									?>
											<select class="custom-select rounded-0" Id="total_rtdept2Code" name="total_rtdept2Code">
												<option value="" selected>분반 선택</option>
											</select>
