						...
						<div class="form-group row">
							<label class="col-sm-1 col-form-label">예배날짜</label>
								...
								<?php
									# 현재 년도와 날짜를 구한다.
									$today = date("Y-m-d");
// 년초라서 년에 있는 것 다 나오게 함. 아래줄	$sql_worshipDate2 = "select worshipDate from attendbasedate where baseYear = '".substr($today,0,4)."' and worshipDate <= '".$today."' order by worshipDate";
