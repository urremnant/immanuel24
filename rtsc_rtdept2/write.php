...
<?php
	...
	$sql = "select concat('D', Max(right(rtdept2Code,5))+1) as rtdetp2code from rtdept2";
			...
			<form class="form-horizontal" method ="POST" name="rtsc" action="write_ok.php" onsubmit="return sendit()">
				...
				<div class="card-body">
					<div class="form-group row">
						<label class="col-sm-2 col-form-label"><font color="red">*</font> 분반코드</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="rtdept2Code" maxlength="50" value="<?php echo $row['rtdetp2code'] ?>">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control" name="rtdept2Name" maxlength="50">
						</div>
					</div>
				</div>
				<!-- /.card-body -->
